...
<body class="custom-cursor ">
    ...
    <nav class="main-menu clearfix shadow-sm rounded">
        <div class="main-menu__wrapper clearfix">
            <div class="container">
                <div class="main-menu__wrapper-inner d-flex justify-content-between">
                        ...
                        <div class="">
                            ...
                            <ul class="main-menu__list">
                                <li class="" id="active-home">
                                    <a href="http://localhost/php">Home</a>
                                </li>
                                <li class="" id="active-about">
                                    <a href="about-us">About Us</a>
                                </li>
                                <li class="" id="active-services">
                                    <a href="services">Our Service</a>
                                </li>
                               
                                <li class="" id="active-products">
                                    <a href="products">Our Product</a>
                                </li>
                                <li class="" id="active-contact">
                                    <a href="contact">Contact Us</a>
                                </li>
                                <li class="d-none d-sm-block d-md-none" id="active-contact">
                                    <a target="_blank" href="http://www.sbp.btp-inc.ca/">Login</a>
                                </li>
                       ...
                       <div class="d-none d-sm-none d-md-block">
                        <div class="menu-phone">
                                    <a class="btn btn-primary login-btn" target="_blank" href="http://www.sbp.btp-inc.ca/">Login</a>
                       </div>
                        </li>
                    </div>
                </div>
          ...
          <div class="row d-flex align-items-center">
            ...
            <div class="col-md-7 col-lg-8 text-center text-md-start">
              ...
              <div class="p-2">
                <div class="main-menu__logo">
                    <h4 class="font-weight-bold" style="color: #04684A;font-weight: bolder;">B<span style="color: #C92A1D">T</span>P</h4>
                    <span style="color: black;">Business, Technology and Process Inc.</span>
                </div>
              </div>
              <!-- Copyright -->
            </div>
            ...
            <div class="col-md-5 col-lg-4 ml-lg-0 text-center text-md-end" >
                <p class="site-footer__bottom-text" style="color: black;">Copyright &copy; <span id="year"></span> All Rights Reserved. 
            </div>
            <!-- Grid column -->
          </div>
        </section>
...
<!--Site Footer End-->
    ...
    <div class="mobile-nav__wrapper">
            ...
            <div class="mobile-nav__content">
                ...
                <div class="">
                    <h4 class="font-weight-bold" style="color: #04684A;font-weight: bolder;">B<span style="color: #C92A1D">T</span>P</h4>
                                <span style="font-size:14px;">Business, Technology and Process Inc.</span>
                </div>
                <!-- /.logo-box -->
